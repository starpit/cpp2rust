...
//
// Ptr<T1> is the refcount model's node pointer.  t1/t2 return null rather than `unimplemented!()`: a
...
fn f1<T1>(a0: Ptr<T1>, a1: Ptr<T1>) -> bool {
    a0 != a1
}
...
fn f4<T1>(a0: Ptr<T1>, a1: Ptr<T1>) -> bool {
    a0 != a1
}
